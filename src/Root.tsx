...
import { ChartScene } from "./CandleChart/components/ChartScene";
import { DESCENDING_CHANNEL_BREAKOUT } from "./CandleChart/scenes/DescendingChannelBreakout";
    ...
    <>
      ...
      <Folder name="CandleChart">
        <Composition
          ...
          width={1920}
          height={1080}
          schema={chartSceneSchema}
          defaultProps={DESCENDING_CHANNEL_BREAKOUT}
        />
      </Folder>
    </>
  );
